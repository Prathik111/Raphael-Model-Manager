...
export interface ModelRecord { id:number; path:string; relative_path:string; filename:string; model_type:ModelType; size_bytes:number; modified_at:number; civitai_model_id:number|null; civitai_version_id:number|null; civitai_url:string|null; civitai_name:string|null; version_name:string|null; base_model:string|null; creator:string|null; description:string|null; tags:string[]; activation_prompts:string[]; source_hash:string|null; thumbnail_path:string|null; cover_path:string|null; cover_position_x:number; cover_position_y:number; updated_at:number; }
